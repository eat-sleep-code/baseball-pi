...
scoreboardUrl = 'https://gd2.mlb.com/components/game/mlb/year_' + now.strftime('%Y') + '/month_' + now.strftime('%m') + '/day_' + now.strftime('%d') + '/scoreboard.xml'
...
if gameCount > 0:
	...
	gamePlayersUrl = 'https://gd2.mlb.com/components/game/mlb/year_' + now.strftime('%Y') + '/month_' + now.strftime('%m') + '/day_' + now.strftime('%d') + '/gid_' + game.id + '/players.xml'
	...
	gameEventsUrl = 'https://gd2.mlb.com/components/game/mlb/year_' + now.strftime('%Y') + '/month_' + now.strftime('%m') + '/day_' + now.strftime('%d') + '/gid_' + game.id + '/game_events.xml'
	#print(gameEventsUrl)
